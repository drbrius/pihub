  ...
  return (
    <div>
      <button
        onClick={toggle}
        disabled={busy}
        className={`w-full border py-3 text-[0.65rem] font-semibold uppercase tracking-luxe transition disabled:opacity-50 ${
          saved
  ...
  return (
    <div className="text-center">
      {!open ? (
        ...
        <form onSubmit={submit} className="space-y-2 border border-hairline bg-ivory/60 p-4 text-left">
          <select
            name="reason"
            required
            className="w-full border border-hairline bg-white px-2.5 py-2 text-xs"
          ...
          <button
            disabled={busy}
            className="w-full bg-ink py-2 text-[0.6rem] font-semibold uppercase tracking-luxe text-gold-light hover:bg-ink-soft disabled:opacity-50"
          >
