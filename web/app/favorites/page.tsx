  ...
  if (!user) {
    return (
      <div className="mx-auto max-w-md py-20 text-center">
        <h1 className="font-serif text-3xl font-medium text-ink">Your Collection</h1>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="mt-1 font-serif text-3xl font-medium text-ink">Saved Properties</h1>
        <div className="mt-3 h-px w-16 bg-gold" />
      </div>

      {favorites.length === 0 ? (
        <p className="border border-dashed border-gold-dark/40 bg-white p-12 text-center font-serif text-lg italic text-stone">
